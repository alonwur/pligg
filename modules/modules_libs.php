...
function module_add_action($location, $the_function, $variables, $weight=0)
{
...
function module_add_action_tpl($location, $the_tpl, $weight=0)
{
...
function module_add_css($the_css, $weight=0)
{
...
function module_add_js($the_js, $weight=0)
{
