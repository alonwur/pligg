...
{$templatelite.get.user}'s {#PLIGG_Visual_TopUsers_TH_News#}
{else}
...
<form name="bulk_moderate" action="{$my_pligg_base}/admin/admin_links.php?action=bulkmod&page={$templatelite.get.page}" method="post">
